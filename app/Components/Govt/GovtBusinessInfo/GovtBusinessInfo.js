...
const govtBusinessInfo = (props) => {
    ...
    <div className="formOutterWrap">
       <form onSubmit={handleSubmit} className="form-style">
        ...
        <Row><Col lg={4} sm={4}><Field name="phoneText1" type="number" label="Phone Number" style={{"width":'80px'}} component={renderField}  validate={[required, positiveValue, minValue(3)]} /></Col>
          <div className="phonetextwrap"><Col lg={4} sm={4}><Field name="phoneText2" type="number"  component={renderField} validate={[required, positiveValue, minValue(3)]} /></Col>
          <Col lg={4} sm={4}><Field name="phoneText3" type="number" component={renderField} validate={[required, positiveValue, minValue(4)]} /></Col>
        </div>
        </Row>
